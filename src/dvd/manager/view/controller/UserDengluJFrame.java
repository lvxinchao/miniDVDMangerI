...
public class UserDengluJFrame extends JFrame {
	...
	public UserDengluJFrame() {
        ...
        dengluJFrame.setTitle("迷你DVD-用户登录窗口");
        ...
        dengluJButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(userText.getText().equals("")||mimaText.getText().equals("")){
	    			...
	    			n=new DVDmanagerDaoImpl().dengluDVDuser(username1,password1);
	    			if(n==1) {
	    				dengluJFrame.dispose();
	    				new UserSystemJFrame();
	    			}else {
